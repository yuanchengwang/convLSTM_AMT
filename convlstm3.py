...
#            nn.Dropout3d(p=0.5, inplace=False))
        ...
        self.lstm3= LSTM(shape=(1,1),input_chans = num_features2*filter_size3[1]*7, filter_size=filter_size1, num_features=num_features3,num_layers=1,batch_size=batch_size) #,
        #shape,input_channel,filter_size,feature_number,layer_number
...
#        x = x.transpose(1,2)
        x = x.reshape(x.shape[0],x.shape[1],x.shape[2]*x.shape[3]*x.shape[4],1,1) 
